...
var _WidgetBox = require('./components/WidgetBox');

var _WidgetBox2 = _interopRequireDefault(_WidgetBox);

var _WidgetHeader = require('./components/header/WidgetHeader');

var _WidgetHeader2 = _interopRequireDefault(_WidgetHeader);

var _WidgetBody = require('./components/body/WidgetBody');
...
var Widget = function Widget(_ref) {
   ...
   return _react2.default.createElement(
      _WidgetBox2.default,
      { className: className },
      _react2.default.createElement(_WidgetHeader2.default, { className: header.className, title: header.title, toolbar: header.toolbar }),
