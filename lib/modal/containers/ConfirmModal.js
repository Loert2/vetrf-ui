...
var ConfirmModal = function (_Component) {
   ...
   function ConfirmModal(props, context) {
      ...
      _this.changeDisabledConfirm = _this.changeDisabledConfirm.bind(_this);
      _this.state = {
         show: true,
         disabled: _this.props.disabledConfirmBtn || false
      };
      return _this;
   }
   ...
   _createClass(ConfirmModal, [{
      ...
      key: 'changeDisabledConfirm',
      value: function changeDisabledConfirm() {
      ...
      value: function render() {
         ...
         var _props2 = this.props,
             ...
             confirmBtn = _props2.confirmBtn,
             cancelBtn = _props2.cancelBtn,
             bodyText = _props2.bodyText;
