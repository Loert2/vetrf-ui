...
var ConfirmModal = function (_Component) {
   ...
   function ConfirmModal(props, context) {
      ...
      _this.returnConfirmBtn = _this.returnConfirmBtn.bind(_this);
      _this.state = {
         show: true
      };
      return _this;
   ...
   _createClass(ConfirmModal, [{
      ...
      key: 'returnConfirmBtn',
      value: function returnConfirmBtn() {
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(_ConfirmFooterModal2.default, { confirmBtn: this.returnConfirmBtn(),
               cancelBtn: {
