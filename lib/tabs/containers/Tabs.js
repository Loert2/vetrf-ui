   ...
   _createClass(Tabs, [{
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            'div',
            { className: 'col-xs-12' },
            _react2.default.createElement(_TabList2.default, { tabs: tabs, onSelect: this.onSelect, selectedName: selectedName }),
            _react2.default.createElement(_TabContentList2.default, { tabs: tabs, selectedName: selectedName })
         );
      }
   }]);
