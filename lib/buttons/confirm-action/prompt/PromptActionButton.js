...
var _CustomActionButton = require('../custom/CustomActionButton');
...
var PromptActionButton = function (_Component) {
   ...
   _createClass(PromptActionButton, [{
      ...
      value: function render() {
         ...
         return _react2.default.createElement(_CustomActionButton2.default, {
            id: id,
            className: className,
            icon: icon,
            ...
            body: _react2.default.createElement(_Textarea2.default, {
               value: valueTextArea,
