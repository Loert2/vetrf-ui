...
var DatePickerTableFilter = function (_Component) {
   ...
   function DatePickerTableFilter(props, context) {
      ...
      _this.returnValidDate = _this.returnValidDate.bind(_this);
   ...
   _createClass(DatePickerTableFilter, [{
      key: 'validDate',
      value: function validDate(date) {
         var formats = ["DD-MM-YYYY", "DD/MM/YYYY", "DD.MM.YYYY"];
         return (0, _moment2.default)(date, formats, true).isValid();
      }
   }, {
      key: 'returnValidDate',
      value: function returnValidDate(date) {
         var formats = ["DD-MM-YYYY", "DD/MM/YYYY", "DD.MM.YYYY"];
         var dateResult = (0, _moment2.default)(date, formats).format("DD.MM.YYYY");
         return dateResult;
      }
   }, {
      key: 'filter',
