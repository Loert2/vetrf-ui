...
require('./DatePickerTableFilter.css');
   ...
   _createClass(DatePickerTableFilter, [{
      ...
      value: function filter(value) {
         var _state = this.state,
             ...
             hasErrorFromState = _state.hasError,
             validlValue = _state.validlValue;
      ...
      value: function validate(date) {
         if (this.validateDate(date)) {
            ...
            var validlValue = this.state.validlValue;
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            'div',
            { className: (0, _classnames2.default)("date-filter form-group", hasError ? errorClassName || "has-error" : "") },
