...
var _RowEmptyList = require('./RowEmptyList');

var _RowEmptyList2 = _interopRequireDefault(_RowEmptyList);

var _AddInfoRow = require('./AddInfoRow');
...
var TableBody = function TableBody(props) {
   ...
   var addInfoRow = addBtn && _react2.default.createElement(_AddInfoRow2.default, { addAction: addBtn.action,
      btnClassName: addBtn.className,
      text: addBtn.text,
      columnsLength: columns.length });
   if (dataList && dataList.length) {
      for (var i = 0; i < dataList.length; i++) {
         rows.push(_react2.default.createElement(_TableRow2.default, { key: keyFunction && keyFunction(dataList[i]) || dataList[i].id || (0, _uniqueId2.default)() //TODO: Убрать uniqueId, постараться его не использовать.
            , columns: columns,
            onClick: onClickRow,
      ...
      return _react2.default.createElement(
         ...
         null,
         rows,
         additionalDataRow && _react2.default.createElement(_TableRow2.default, { key: 'additionalRow',
