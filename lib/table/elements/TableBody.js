...
var TableBody = function TableBody(props) {
   ...
   if (dataList && dataList.length) {
      for (var i = 0; i < dataList.length; i++) {
         rows.push(_react2.default.createElement(_TableRow2.default, { key: keyFunction(dataList[i]) || dataList[i].id || (0, _uniqueId2.default)() //TODO: Убрать uniqueId, постараться его не использовать.
            , columns: columns,
            onClick: onClickRow,
