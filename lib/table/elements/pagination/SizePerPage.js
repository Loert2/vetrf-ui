...
var SizePerPage = function SizePerPage(_ref) {
   ...
   return _react2.default.createElement(_SimpleSelect2.default, { className: 'clear-both dropdown-width',
      ...
      value: { id: sizePerPage || _constants2.default.SIZE_PER_PAGE, name: sizePerPage || _constants2.default.SIZE_PER_PAGE },
      options: options || _constants2.default.SIZE_PER_PAGE_LIST });
};
