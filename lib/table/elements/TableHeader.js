...
var _HeaderColumn = require('./HeaderColumn');

var _HeaderColumn2 = _interopRequireDefault(_HeaderColumn);

var _FilterCell = require('./filter/FilterCell');
...
var TableHeader = function TableHeader(_ref) {
   ...
   for (var i = 0; i < columns.length; i++) {
      ...
      headerColumns.push(_react2.default.createElement(_HeaderColumn2.default, { key: key,
         id: key,
         sortedId: sortedId,
   ...
   if (filterableTable) {
      for (var _i = 0; _i < columns.length; _i++) {
         filterColumns.push(_react2.default.createElement(_FilterCell2.default, { key: columns[_i].key || (0, _uniqueId2.default)(),
