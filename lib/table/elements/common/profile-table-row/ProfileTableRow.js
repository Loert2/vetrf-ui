...
var ProfileTableRow = function ProfileTableRow(_ref) {
   var first = _ref.first,
       ...
       getCellClass = _ref.getCellClass;

   var cells = [];
   cells.push(_react2.default.createElement(_HeaderColumn2.default, {
      key: header.key || (0, _uniqueId2.default)(),
   ...
   for (var i = 0; i < itemList.length; i++) {
      cells.push(_react2.default.createElement(_TableCell2.default, {
         ...
         className: (0, _classnames2.default)(itemList[i].cellClassName, getCellClass && getCellClass(itemList[i].item)),
