...
var _constants = require('../../table/elements/constants');
...
var getIconClass = function getIconClass(sortType) {
   switch (sortType) {
      case _constants2.default.SORT_ASC:
         return "fa-sort-asc";
      case _constants2.default.SORT_DESC:
         return "fa-sort-desc";
      default:
         return "fa-sort";
   }
...
var initialState = {
   sort: _constants2.default.SORT_UNDEFINED,
   sortIcon: "fa-sort"
};
...
var HeaderColumn = function (_Component) {
   ...
   _createClass(HeaderColumn, [{
      ...
      value: function changeSort() {
         if (this.state.sort !== _constants2.default.SORT_UNDEFINED) {
            switch (this.state.sort) {
               case _constants2.default.SORT_ASC:
                  return _constants2.default.SORT_DESC;
               case _constants2.default.SORT_DESC:
                  return _constants2.default.SORT_UNDEFINED;
               default:
                  return _constants2.default.SORT_ASC;
            }
         }
         return _constants2.default.SORT_ASC;
      }
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(
               ...
               title,
               '\xA0',
               sortable && onSort && _react2.default.createElement('i', { className: (0, _classnames2.default)("sort-caret fa", this.state.sortIcon || "fa-sort"),
