...
var NativeCheckbox = function (_React$PureComponent) {
   _inherits(NativeCheckbox, _React$PureComponent);

   function NativeCheckbox() {
      _classCallCheck(this, NativeCheckbox);

      return _possibleConstructorReturn(this, (NativeCheckbox.__proto__ || Object.getPrototypeOf(NativeCheckbox)).apply(this, arguments));
   }
...
NativeCheckbox.defaultProps = {
   indeterminate: false
};
exports.default = NativeCheckbox;