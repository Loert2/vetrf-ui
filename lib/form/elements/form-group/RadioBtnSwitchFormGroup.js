      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            { labelText: labelText,
               ...
               errorText: errorText },
            _react2.default.createElement(_RadioBtn2.default, { id: itemTrue.id,
               name: name,
               value: 'true',
               ...
               checked: value === true,
               disabled: disabled }),
            _react2.default.createElement(_RadioBtn2.default, { id: itemFalse.id,
               name: name,
               value: 'false',
...
RadioBtnSwitchFormGroup.propTypes = {
   itemTrue: _propTypes2.default.arrayOf(_propTypes2.default.shape({
      id: _propTypes2.default.string,
      className: _propTypes2.default.string,
      text: _propTypes2.default.string
   })),
   itemFalse: _propTypes2.default.arrayOf(_propTypes2.default.shape({
      id: _propTypes2.default.string,
      className: _propTypes2.default.string,
      text: _propTypes2.default.string
   })),
