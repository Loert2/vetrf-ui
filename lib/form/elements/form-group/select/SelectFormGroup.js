...
var SelectFormGroup = function SelectFormGroup(props) {
   var labelText = props.labelText,
       ...
       restProps = _objectWithoutProperties(props, ['labelText', 'require', 'disabled', 'help', 'errorClassName', 'additionalBlock', 'errorText', 'hasError', 'labelClassName', 'fieldClassName', 'multiple', 'value', 'name', 'id', 'style', 'styleInput', 'options', 'onChange', 'valueKey', 'labelKey', 'className', 'placeholder', 'field', 'clearable']);
