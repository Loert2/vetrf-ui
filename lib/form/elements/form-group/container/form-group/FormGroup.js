...
var FormGroup = function FormGroup(props) {
   var hasError = props.hasError,
       ...
       errorTextClassName = props.errorTextClassName,
   ...
   return _react2.default.createElement(
      ...
      _react2.default.createElement(
         ...
         hasError && errorText && _react2.default.createElement(
            'p',
            { className: (0, _classnames2.default)("help-block has-error form-group__error", errorTextClassName) },
            errorText
         )
      )
   );
...
FormGroup.propTypes = {
   ...
   errorTextClassName: _propTypes2.default.string,
