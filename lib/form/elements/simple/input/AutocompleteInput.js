...
var AutocompleteInput = function (_Component) {
   ...
   function AutocompleteInput(props, context) {
      ...
      _this.requestAutocompleteList = (0, _debounce2.default)(props.onAutocomplete, 600);
      return _this;
   }
      ...
      value: function changeHandler(value) {
         ...
         if (name || field) {
            if (value && value.length > 2) {
               this.requestAutocompleteList(name ? _defineProperty({}, name, value) : value, name || field);
            ...
            return _react2.default.createElement(
               ...
               { key: (0, _uniqueId2.default)(),
                  onClick: function onClick() {
                     _this2.hideHelp();onSelect && onSelect(item, name || field);
                  } },
