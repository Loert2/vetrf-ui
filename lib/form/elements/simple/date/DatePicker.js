...
var DatePicker = function (_PureComponent) {
   ...
   function DatePicker(props, context) {
      ...
      _this.validateFormat = props.validate ? (0, _debounce2.default)(props.validate, 300) : null;
   ...
   _createClass(DatePicker, [{
      ...
      value: function validDate(date) {
         return (0, _moment2.default)(date, "DD.MM.YYYY", true).isValid();
      }
   }, {
      key: 'render',
