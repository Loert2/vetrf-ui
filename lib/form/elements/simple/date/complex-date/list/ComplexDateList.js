   ...
   _createClass(ComplexDateList, [{
      ...
      value: function getComplexDateList(list) {
         ...
         var _props = this.props,
             ...
             getBeginDatePath = _props.getBeginDatePath,
             getEndDatePath = _props.getEndDatePath,
             getSingleDatePath = _props.getSingleDatePath,
             getFormatPath = _props.getFormatPath,
         ...
         return list && list.map(function (it, index) {
            return _react2.default.createElement(
               'div',
               { key: index, className: 'col-xs-12 no-padding' },
               _react2.default.createElement(
                  'div',
                  { className: (list.length > 1 ? "col-xs-11" : "col-xs-12") + ' no-padding' },
               ...
               list.length > 1 && _react2.default.createElement(
                  'div',
                  { className: 'col-xs-1 no-padding-left' },
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(
               ...
               _react2.default.createElement(
                  'p',
                  { className: 'col-xs-10 no-padding-left padding-top-2 help-block' },
...
ComplexDateList.propTypes = {
   ...
   getBeginDatePath: _propTypes2.default.func,
   getEndDatePath: _propTypes2.default.func,
   getSingleDatePath: _propTypes2.default.func,
   getFormatPath: _propTypes2.default.func,
