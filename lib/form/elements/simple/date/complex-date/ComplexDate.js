...
var ComplexDate = function (_Component) {
   ...
   _createClass(ComplexDate, [{
      ...
      value: function toggleForm() {
         ...
         var beforeToggleIsValid = this.isValid();
         this.setState(function (oldState) {
            ...
            return _this2.postToggleValidate(isInterval, startDateTime, singleDateTime, beforeToggleIsValid);
         });
      }
   }, {
      key: 'postToggleValidate',
      value: function postToggleValidate(isInterval, beginDate, singleDate, beforeToggleIsValid) {
         ...
         this.validateFormat(field, beforeToggleIsValid)((0, _momentUtils.formatValue)(value, storeFormat, format));
      }
   }, {
      key: 'validateFormat',
      value: function validateFormat(isValidField, beforeToggleIsValid) {
         var _this3 = this;

         return function (value) {
            var _props6 = _this3.props,
                _props6$complexDate$f = _props6.complexDate.format,
                format = _props6$complexDate$f === undefined ? _momentUtils.defaultFormat : _props6$complexDate$f,
                handleChangeValidity = _props6.handleChangeValidity;

            var oldValid = beforeToggleIsValid !== undefined ? beforeToggleIsValid : _this3.isValid();
      ...
      value: function getChangeDateHandler(path) {
         ...
         var _props7 = this.props,
             ...
             complexDatePath = _props7.complexDatePath;
      ...
      value: function getNewComplexDate(value, path) {
         var _props8 = this.props,
             ...
             complexDate = _props8$complexDate === undefined ? {} : _props8$complexDate;
      ...
      value: function render() {
         ...
         var _props9 = this.props,
             formatPlaceholder = _props9.formatPlaceholder,
             errorText = _props9.errorText,
             _props9$storeFormat = _props9.storeFormat,
             storeFormat = _props9$storeFormat === undefined ? _momentUtils.defaultStoreFormat : _props9$storeFormat,
             formatList = _props9.formatList,
             _props9$complexDate = _props9.complexDate,
             _props9$complexDate$d = _props9$complexDate.dateInterval;
         _props9$complexDate$d = _props9$complexDate$d === undefined ? {} : _props9$complexDate$d;
         var startDateTime = _props9$complexDate$d.startDateTime,
             endDateTime = _props9$complexDate$d.endDateTime,
             _props9$complexDate$f = _props9$complexDate.format,
             format = _props9$complexDate$f === undefined ? _momentUtils.defaultFormat : _props9$complexDate$f,
             singleDateTime = _props9$complexDate.singleDateTime;


         var dateForm = null;
         var formClass = null;
         if (isInterval) {
            dateForm = _react2.default.createElement(_DateRange2.default, {
            ...
            dateForm = _react2.default.createElement(_index.DatePicker, {
               value: (0, _momentUtils.formatValue)(singleDateTime, storeFormat, format),
               dateFormat: format.dateFormat,
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(
               ...
               _react2.default.createElement(
                  ...
                  _react2.default.createElement(_index.Switch, { value: isInterval, text: '', onChange: this.toggleForm })
               ),
               '\xA0',
               _react2.default.createElement(
                  'span',
            ...
            showError && _react2.default.createElement(
               'p',
               { className: 'help-block has-error complex-date__error-block' },
...
ComplexDate.propTypes = {
   ...
   handleChangeValidity: _propTypes2.default.func,
