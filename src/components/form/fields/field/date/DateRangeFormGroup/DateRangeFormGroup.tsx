...
import DateRange from '../../../base/date/DateRange/DateRange';
...
class DateRangeFormGroup extends Component<any> {
   state = {
...
(DateRangeFormGroup as any).propTypes = {
...
(DateRangeFormGroup as any).defaultProps = {};
