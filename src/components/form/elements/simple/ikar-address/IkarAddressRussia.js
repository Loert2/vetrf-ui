      ...
      <div className={ formClassName }>
         {
            ...
            <SelectFormGroup id="ikarAddressSelectInputCountry"
         ...
         }
         {
            ...
            <SelectFormGroup id="ikarAddressSelectInputRegion"
         ...
         {
            districtOptions && (districtOptions.isHidden === false) &&
            <SelectFormGroup id="ikarAddressSelectInputDistrict"
         ...
         {
            localityOptions && !localityOptions.isHidden &&
            <AsyncSelectFormGroup id="ikarAddressSelectInputLocality"
         ...
         {
            subLocalityOptions && (subLocalityOptions.isHidden === false) &&
            <AsyncSelectFormGroup id="ikarAddressSelectInputSubLocality"
         ...
         {
            streetOptions && !streetOptions.isHidden &&
            <AsyncSelectFormGroup id="ikarAddressSelectInputStreet"
         ...
         {
            houseOptions && !houseOptions.isHidden &&
            <InputFormGroup id="ikarAddressInputHouse"
         ...
         {
            buildingOptions && !buildingOptions.isHidden &&
            <InputFormGroup id="ikarAddressInputBuilding"
         ...
         {
            roomOptions && !roomOptions.isHidden &&
            <InputFormGroup id="ikarAddressInputRoom"
         ...
         {
            postIndexOptions && !postIndexOptions.isHidden &&
            <NumberFormGroup id="ikarAddressInputPostIndex"
                             ...
                             errorText={ postIndexOptions.isRequiredField && (postIndexOptions.errorText || THIS_FIELD_MUST_BE_FILLED) }
                             labelClassName={ formGroupLabelClassName }
                             fieldClassName={ formGroupFieldClassName } />
         }
         {
            postBoxOptions && !postBoxOptions.isHidden &&
            <InputFormGroup id="ikarAddressInputPostBox"
         ...
         {
            additionalInfoOptions && !additionalInfoOptions.isHidden &&
            <InputFormGroup id="ikarAddressInputAdditinalInfo"
