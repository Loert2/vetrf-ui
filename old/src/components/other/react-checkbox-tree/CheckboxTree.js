...
import CheckboxTreeButton from './CheckboxTreeButton';
...
import { ICON_PREFIX, CHECK, UNCHECK, HALFCHECK } from './const/CheckboxTreeConst';
...
class CheckboxTree extends React.Component {
   ...
   renderExpandAll() {
      ...
      const { expandAll, collapseAll } = this.iconsElements;
