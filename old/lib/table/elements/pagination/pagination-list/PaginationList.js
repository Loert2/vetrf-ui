   ...
   _createClass(PaginationList, [{
      ...
      value: function makePage() {
         ...
         return pages.map(function (page, index) {
            ...
            if (page === _index2.default.DELIMITER_PAGINATION) {
               disabled = true;
               hidden = false;
            }
            return _react2.default.createElement(
      ...
      value: function getPages() {
         ...
         if (startPage !== pageStartIndex && this.totalPages > paginationSize) {
            pages = [prePage, pageStartIndex, _index2.default.DELIMITER_PAGINATION];
         ...
         if (endPage < this.lastPage) {
            pages.push(_index2.default.DELIMITER_PAGINATION);
...
PaginationList.defaultProps = {
   sizePerPage: _index2.default.SIZE_PER_PAGE,
   pageStartIndex: _index2.default.PAGE_START_INDEX
};
