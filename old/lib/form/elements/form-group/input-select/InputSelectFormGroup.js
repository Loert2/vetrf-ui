      ...
      _react2.default.createElement(
         ...
         _react2.default.createElement(
            ...
            _react2.default.createElement(
               'span',
               { className: 'col-md-6' },
               input.number || input.float ? _react2.default.createElement(_NumberInput2.default, {
                  name: input.name,
                  id: input.id,
...
exports.default = (0, _withValidate2.default)(InputSelectFormGroup, function (props) {
   return props.require && (!props.input.value || !props.select.value);
});