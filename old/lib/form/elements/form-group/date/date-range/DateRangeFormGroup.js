...
var DateRangeFormGroup = function (_Component) {
   ...
   function DateRangeFormGroup(props, context) {
      ...
      _this.getValidateFormat = _this.getValidateFormat.bind(_this);
   ...
   _createClass(DateRangeFormGroup, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
         ...
         var defaultValidate = function defaultValidate() {
            return !_this2.isValid() || require && !beginDate && !endDate;
         };
      ...
      key: 'validateFormat',
      value: function validateFormat(value, validField) {
         this.setState(_extends({}, this.state, _defineProperty({}, validField, (0, _validateUtils.isValidDate)(value) || (0, _isEmpty2.default)(value))));
      }
   }, {
      key: 'getValidateFormat',
      value: function getValidateFormat(validField) {
         var _this3 = this;

         return function (value) {
            return _this3.validateFormat(value, validField);
         };
      }
   }, {
      key: 'isValid',
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(_simple.DateRange, {
               id: id,
               className: className,
