   ...
   _createClass(IkarAddress, [{
      ...
      value: function render() {
         ...
         if (isRussia(country)) {
            ...
            form = _react2.default.createElement(_IkarAddressRussia2.default, {
            ...
            form = _react2.default.createElement(_IkarAddressForeign2.default, {
               ikarAddressOptions: _ikarAddressOptions,
               countries: countries,
               regions: regions,
               address: address,
               getChangeHandlerByField: this.getChangeHandlerByField,
