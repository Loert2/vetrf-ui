...
export default class NavSearch extends Component {
   ...
   render () {
      ...
      let content = this.props.content && this.props.content.content && this.props.content.content.filter(elem => {
            if (this.props.selected) {
               return !this.props.selected.some(e => e[this.props.idType] === elem[[this.props.idType]]);
            }
            return true;
         });
      return (
         <div id="nav-search" className="nav-search">
            <form className="form-search">
               <span className="input-icon">
                  <Input className="nav-search-input width-260"
                         autoComplete="off"
...

            {
               ...
               <div className="result">
                  <ul>
                     {
                        this.props.content && this.props.content.error &&
                     ...
                     {
                        this.props.content && !this.props.content.loading && !this.props.content.error && content.length === 0 &&
